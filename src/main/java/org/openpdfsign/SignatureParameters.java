...
public class SignatureParameters {
    ...
    @Parameter(required = false, names={"--hsm-library"}, description = "path to the PKCS#11 library for HSM")
    @JsonProperty("hsm-library")
    private String hsmLibrary;

    @Parameter(required = false, names={"--hsm-slot"}, description = "slot ID for the HSM")
    @JsonProperty("hsm-slot")
    private Integer hsmSlot;

    @Parameter(required = false, names={"--hsm-pin"}, description = "PIN for the HSM token")
